...
"""
    ...
    def test_parse_yotta_target_cmd_output_mixed_chars(self):
        ...
        self.assertIn(
            "aaaaaaaaaaaaa",
            mbed_target_info.parse_yotta_target_cmd_output("aaaaaaaaaaaaa 0.0.0"),
        )
        self.assertIn(
            "aaaa-bbbb-cccc",
            mbed_target_info.parse_yotta_target_cmd_output("aaaa-bbbb-cccc 0.0.0"),
        )
        self.assertIn(
            "aBc-DEF_hijkkk",
            mbed_target_info.parse_yotta_target_cmd_output("aBc-DEF_hijkkk 0.0.0"),
        )

    def test_parse_yotta_target_cmd_output_mixed_version(self):
        self.assertIn(
            "frdm-k64f-gcc",
            mbed_target_info.parse_yotta_target_cmd_output("frdm-k64f-gcc 0.0.0"),
        )
        self.assertIn(
            "frdm-k64f-gcc",
            mbed_target_info.parse_yotta_target_cmd_output("frdm-k64f-gcc 1.1.1"),
        )
        self.assertIn(
            "frdm-k64f-gcc",
            mbed_target_info.parse_yotta_target_cmd_output("frdm-k64f-gcc 1.1.12"),
        )
        self.assertIn(
            "frdm-k64f-gcc",
            mbed_target_info.parse_yotta_target_cmd_output("frdm-k64f-gcc 1.1.123"),
        )
        self.assertIn(
            "frdm-k64f-gcc",
            mbed_target_info.parse_yotta_target_cmd_output("frdm-k64f-gcc 11.22.33"),
        )
        self.assertIn(
            "frdm-k64f-gcc",
            mbed_target_info.parse_yotta_target_cmd_output("frdm-k64f-gcc 0.0.1"),
        )
        self.assertIn(
            "frdm-k64f-gcc",
            mbed_target_info.parse_yotta_target_cmd_output("frdm-k64f-gcc 0.10.12"),
        )
        self.assertIn(
            "frdm-k64f-gcc",
            mbed_target_info.parse_yotta_target_cmd_output("frdm-k64f-gcc 0.20.123"),
        )
        self.assertIn(
            "frdm-k64f-gcc",
            mbed_target_info.parse_yotta_target_cmd_output("frdm-k64f-gcc 0.2.123"),
        )
        self.assertIn(
            "frdm-k64f-gcc",
            mbed_target_info.parse_yotta_target_cmd_output("frdm-k64f-gcc 10.20.123"),
        )
        self.assertIn(
            "frdm-k64f-gcc",
            mbed_target_info.parse_yotta_target_cmd_output("frdm-k64f-gcc 110.200.123"),
        )

    def test_parse_yotta_target_cmd_output(self):
        self.assertIn(
            "frdm-k64f-gcc",
            mbed_target_info.parse_yotta_target_cmd_output("frdm-k64f-gcc 0.0.24"),
        )
        self.assertIn(
            "frdm-k64f-armcc",
            mbed_target_info.parse_yotta_target_cmd_output("frdm-k64f-armcc 1.12.3"),
        )
        self.assertIn(
            "mbed-gcc",
    ...
    def test_parse_yotta_target_cmd_output_fail(self):
        ...
        self.assertEqual(
            None,
            mbed_target_info.parse_yotta_target_cmd_output("stm32f429i-disco-gcc 1"),
        )
        self.assertEqual(
            None,
            mbed_target_info.parse_yotta_target_cmd_output("stm32f429i-disco-gcc 1."),
        ...
        self.assertEqual(
            None,
            mbed_target_info.parse_yotta_target_cmd_output("stm32f429i-disco-gcc 1.0"),
        )
        self.assertEqual(
            None,
            mbed_target_info.parse_yotta_target_cmd_output("stm32f429i-disco-gcc 1.0."),
...
"""
    ...
    def test_parse_yotta_search_cmd_output_new_style(self):
        self.assertIn(
            "frdm-k64f-gcc",
            mbed_target_info.parse_yotta_search_cmd_output("frdm-k64f-gcc 0.1.4"),
        )
        self.assertIn(
            "frdm-k64f-armcc",
            mbed_target_info.parse_yotta_search_cmd_output("frdm-k64f-armcc 0.1.4"),
        )
        pass
...
"""
    ...
    def test_parse_mbed_target_from_target_json(self):
        ...
        self.assertEqual(
            None,
            mbed_target_info.parse_mbed_target_from_target_json("", target_json_data),
        )
        self.assertEqual(
            None,
            mbed_target_info.parse_mbed_target_from_target_json(
...
"""
    ...
    def test_get_yotta_target_from_local_config_invalid_path(self):
        result = mbed_target_info.get_yotta_target_from_local_config(
            "invalid_path.json"
        )
    ...
    def test_get_mbed_targets_from_yotta_local_module_invalid_path(self):
        result = mbed_target_info.get_mbed_targets_from_yotta_local_module(
            "null", "invalid_path"
        )
    ...
    def test_get_platform_property_from_targets_no_json(self):
        with patch("mbed_os_tools.test.mbed_target_info._find_targets_json") as _find:
            ...
            result = mbed_target_info._get_platform_property_from_targets(
                "not_a_platform", "not_a_property", "default"
            )
            self.assertIsNone(result)

    def test_get_platform_property_from_targets_no_file(self):
        with patch(
            "mbed_os_tools.test.mbed_target_info._find_targets_json"
        ) as _find, patch("mbed_os_tools.test.mbed_target_info.open") as _open:
    ...
    def test_platform_property(self):
        ...
        """
        with patch(
            "mbed_os_tools.test.mbed_target_info._get_platform_property_from_targets"
        ) as _targets, patch(
            "mbed_os_tools.test.mbed_target_info._get_platform_property_from_info_mapping"
        ) as _info_mapping, patch(
            "mbed_os_tools.test.mbed_target_info._get_platform_property_from_default"
        ) as _default:
            # 1
            ...
            self.assertEqual(
                mbed_target_info.get_platform_property("K64F", "copy_method"), "targets"
            )
            # 2
            ...
            _info_mapping.return_value = None
            self.assertEqual(
                mbed_target_info.get_platform_property("K64F", "copy_method"), "default"
            )
            # 5
            _default.return_value = None
            self.assertEqual(
                mbed_target_info.get_platform_property("K64F", "copy_method"), None
            )
            # 6
            _targets.return_value = "targets"
            self.assertEqual(
    ...
    def test_parse_yotta_json_for_build_name(self):
        ...
        self.assertEqual(
            None, mbed_target_info.parse_yotta_json_for_build_name({"build": {}})
        )

        self.assertEqual(
            "frdm-k64f-gcc",
            mbed_target_info.parse_yotta_json_for_build_name(
                {"build": {"target": "frdm-k64f-gcc,*", "targetSetExplicitly": True}}
            ),
        )
        ...
        self.assertEqual(
            "x86-linux-native",
            mbed_target_info.parse_yotta_json_for_build_name(
                {"build": {"target": "x86-linux-native,*", "targetSetExplicitly": True}}
            ),
        )
