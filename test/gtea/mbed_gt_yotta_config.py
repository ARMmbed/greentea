...
import unittest
from mbed_os_tools.test.mbed_yotta_module_parse import YottaConfig
...
class YOttaConfigurationParse(unittest.TestCase):
    def setUp(self):
        self.YOTTA_CONFIG_LONG = {
            ...
            "mbed-os": {
                "net": {"stacks": {"lwip": True}},
                "stdio": {"default-baud": 9600},
            },
            "cmsis": {
                "nvic": {
            ...
            "hardware": {
                ...
                "test-pins": {
                    ...
                    "i2c": {"sda": "PTE25", "scl": "PTE24"},
                    "serial": {"tx": "PTC17", "rx": "PTD2"},
                },
            },
            "uvisor": {"present": 1},
            "arch": {"arm": {}},
